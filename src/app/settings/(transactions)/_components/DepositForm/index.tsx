...
const DepostiForms = () => {
  ...
  // submit handler
  const handleSubmitComapny: SubmitHandler<IDeposite> = async (formData) => {
    ...
    >
      ...
      >
        <div className="grid md:grid-cols-2 gap-4">
          <TextInput
            {...register("processingFeePerecent", {
