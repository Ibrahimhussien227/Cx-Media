...
import { ICampaignExtensionForm } from "./type";

const CampaignExtensionForms = () => {
  const {
    reset,
    handleSubmit,
    register,
  ...
  // submit handler
  const handleSubmitComapny: SubmitHandler<ICampaignExtensionForm> = async (
    formData
  ) => {
...
export default CampaignExtensionForms;
